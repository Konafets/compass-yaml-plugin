...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/yaml/compass_plugin.rb", "lib/yaml/sass_extensions.rb", "lib/yaml-css.rb", "Manifest", "Rakefile", "README.mkdn", "sass/yaml/core/_base.sass", "sass/yaml/core/_iehacks.sass", "sass/yaml/print/print_draft.css", "templates/project/base.sass", "templates/project/manifest.rb", "templates/project/patch_my_layout.sass", "VERSION", "compass-yaml-plugin.gemspec"]
